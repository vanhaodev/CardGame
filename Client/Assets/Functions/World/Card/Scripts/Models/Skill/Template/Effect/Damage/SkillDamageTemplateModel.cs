...
namespace World.TheCard.Skill
{
    ...
    public class SkillDamageTemplateModel : SkillEffectTemplateModel
    {
        ...
        /// <br/>
        /// Nếu không chí mạng, S_CritDamage mặc định là 1 (không thay đổi sát thương).
        /// <br/>
        /// Ví dụ: S_Attack = 100, R_Defense = 10, S_CritDamage = 1.5 (crit success), 
        /// <br/>
        /// Damage = ((100 * 1.70) + 255) * 1.5 - 10 = 622.5
        /// </summary>
        public string Formula = "(((S_Attack * 1.70) + 255) * S_CritDamage) - R_Defense";
    }
}